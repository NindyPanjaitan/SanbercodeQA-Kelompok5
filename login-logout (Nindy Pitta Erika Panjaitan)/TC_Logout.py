...
class TestLoginOrangeHRM(unittest.TestCase):
    ...
    def test_a_logout_OrangeHRM_success(self):
        driver = self.driver
        ...
        time.sleep(2)  
        driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[1]/header/div[1]/div[2]/ul/li/span/i").click() #click profile
        time.sleep(2) 
        driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[1]/header/div[1]/div[2]/ul/li/ul/li[4]/a").click() #click logout
        time.sleep(2)
        print("User LogOut")   
